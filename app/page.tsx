		...
		<main className="flex flex-col items-center justify-between p-12 sm:p-14 md:p-18">
			...
			<div className="mt-12 text-center max-w-md">
				<p className="text-gray-600 dark:text-gray-300 mb-6">
					...
					projects using the navigation bar below. My portfolio is a mixed match
					of MacOS and Windows combined themes.
				</p>
				<div className="flex flex-wrap justify-center gap-4">
					...
					<a
						...
						className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-gray-800 dark:bg-gray-200 text-black dark:text-gray-800 hover:bg-gray-700 dark:hover:bg-gray-300 transition-colors"
					>
