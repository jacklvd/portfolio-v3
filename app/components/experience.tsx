...
const ExperienceSection: React.FC = () => {
  ...
  return (
    <section className="section">
      ...
      <span className="section_subtitle">Each journey taught me to better</span>
      <div className=" text-gray-800 p-4 font-sans container mx-auto">
        <div className="flex flex-col md:flex-row">
          <div
            className={`w-full md:flex-none md:w-64 ${isMobile ? 'mb-4' : 'pr-4'}`}
          >
            {isMobile ? (
              ...
              <p>
                {selectedExperience.description.map((des, index) => (
                  <motion.li
                    ...
                    initial="hidden"
                    animate="visible"
                    custom={index} // This passes the index to the variant for delay calculation
                    className="flex"
                  >
